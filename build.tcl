...
#
# Generated by Vivado on Mon Jul 03 02:10:13 -0500 2017
...
#
#    "C:/Users/Wong0880/workspace/imc/hdl/msg_extractor_fsm.v"
#    "C:/Users/Wong0880/workspace/imc/hdl/message_extractor_tb.v"
#    "C:/Users/Wong0880/workspace/imc/project_1/message_extractor_tb_behav.wcfg"
#
#*****************************************************************************************
...
# Create project
create_project project_1 ./project_1 -part xc7a200tfbg676-2
...
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/project_1.cache/compile_simlib/vcs" -objects $obj
...
set files [list \
 "[file normalize "$origin_dir/hdl/msg_extractor_fsm.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/hdl/msg_extractor_fsm.v"
...
set_property -name "top" -value "msg_extractor_fsm" -objects $obj
...
set files [list \
 "[file normalize "$origin_dir/hdl/message_extractor_tb.v"]"\
 "[file normalize "$origin_dir/project_1/message_extractor_tb_behav.wcfg"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/hdl/message_extractor_tb.v"
set file [file normalize $file]
...
set file "$origin_dir/project_1/message_extractor_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "message_extractor_tb" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a200tfbg676-2 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
